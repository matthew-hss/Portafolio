...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "PORTAFOLIO"."SPECIALVOUCHER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "PORTAFOLIO"."SPECIALVOUCHER" 
   (	"ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PORTAFOLIO"."SPECIALVOUCHER_PK" ON "PORTAFOLIO"."SPECIALVOUCHER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" ADD CHECK ("USED" IN(0,1)) ENABLE;
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" MODIFY ("FUNCTIONARY_ID" NOT NULL ENABLE);
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" MODIFY ("AMOUNT" NOT NULL ENABLE);
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" ADD CONSTRAINT "SPECIALVOUCHER_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" MODIFY ("DATETIME" NOT NULL ENABLE);
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" MODIFY ("USED" NOT NULL ENABLE);
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" MODIFY ("CODE" NOT NULL ENABLE);
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" ADD CONSTRAINT SPECIALVOUCHER_UNQ UNIQUE("CODE");
...
--------------------------------------------------------
  ...
  ALTER TABLE "PORTAFOLIO"."SALE" ADD CONSTRAINT "SALE_FK3" FOREIGN KEY ("SPECIALVOUCHER_ID")
	  REFERENCES "PORTAFOLIO"."SPECIALVOUCHER" ("ID") ON DELETE CASCADE ENABLE;
  ...
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" ADD CONSTRAINT "SPECIALVOUCHER_FK1" FOREIGN KEY ("FUNCTIONARY_ID")
	  REFERENCES "PORTAFOLIO"."FUNCTIONARY" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "PORTAFOLIO"."SPECIALVOUCHER" ADD CONSTRAINT "SPECIALVOUCHER_FK2" FOREIGN KEY ("SALE_ID")
	  REFERENCES "PORTAFOLIO"."SALE" ("ID") ON DELETE CASCADE ENABLE;
...
ALTER TRIGGER "PORTAFOLIO"."VOUCHER_TRG" ENABLE;
  ...
  CREATE OR REPLACE TRIGGER "PORTAFOLIO"."SPECIALVOUCHER_TRG" 
BEFORE INSERT ON "PORTAFOLIO"."SPECIALVOUCHER" 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT "PORTAFOLIO"."SPECIALVOUCHER_SEQ".NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "PORTAFOLIO"."SPECIALVOUCHER_TRG" ENABLE;
